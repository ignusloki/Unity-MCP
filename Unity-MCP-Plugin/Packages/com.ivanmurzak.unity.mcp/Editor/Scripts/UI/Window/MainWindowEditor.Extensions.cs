        ...
        private static readonly ExtensionPanel.ExtensionData[] _extensions =
        {
            ...
            new(
                ...
                tools: new[]
                {
                    ...
                    ("assets-shadergraph-query-structure",      "Read a filtered, token-cheap subset of graph structure"),
                    ...
                    ("assets-shadergraph-reorder-property",     "Reorder blackboard properties within categories"),
                    ("assets-shadergraph-create-category",      "Create blackboard categories"),
                    ("assets-shadergraph-delete-category",      "Delete a blackboard category, optionally reassigning properties"),
                    ("assets-shadergraph-prune-empty-categories", "Delete every empty blackboard category"),
                    ("assets-shadergraph-set-property-category", "Move blackboard properties into categories"),
                    ...
                    ("assets-shadergraph-duplicate-node",       "Duplicate supported graph nodes without copying edges"),
                    ("assets-shadergraph-delete-node",          "Delete existing graph nodes with edge cleanup"),
                    ("assets-shadergraph-update-node-settings", "Update supported serialized settings on existing graph nodes"),
                    ...
                    ("assets-shadergraph-batch",                "Apply an ordered list of mutation operations in one call"),
                    ("assets-shadersubgraph-create",            "Create a Sub Graph asset from a template or preset"),
                    ("assets-shadersubgraph-set-outputs",       "Declare a Sub Graph's output port contract"),
                },
